  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ajouter/Ou Modifier un Utilisateur <i class="fa fa-user-circle-o"
      ...
      <form id="addform" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="message-text" class="col-form-label">ID carte:</label>
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1"><i class="fa fa-phone"
                    aria-hidden="true"></i></span>
              </div>
              <input type="number" class="form-control" id="phone" name="phone" required="required" maxLength="5"
                minLength="10">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              ...
              <div class="custom-file">
                ...
                <label class="custom-file-label" for="userphoto">Choisir un fichier</label>
              </div>
            </div>
